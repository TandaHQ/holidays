...
module Holidays
  ...
  module AU # :nodoc:
    ...
    def self.holidays_by_month
      ...
      12 => [{:mday => 25, :name => "Christmas Day", :regions => [:au_act, :au_nsw, :au_qld, :au_tas, :au_vic, :au_wa, :au_nt]},
            {:mday => 25, :function => "sa_christmas_exclude_saturday(date)", :function_arguments => [:date],  :year_ranges => [{:before => 2023}],:name => "Christmas Day", :regions => [:au_sa]},
            {:mday => 25,  :year_ranges => [{:after => 2024}],:name => "Christmas Day", :regions => [:au_sa]},
            ...
            {:mday => 25, :function => "additional_holiday_on_monday_if_on_sunday(date)", :function_arguments => [:date],  :year_ranges => [{:before => 2023}],:name => "Additional public holiday for Christmas Day", :regions => [:au_sa]},
            {:mday => 25, :function => "additional_holiday_on_monday_if_on_weekend(date)", :function_arguments => [:date],  :year_ranges => [{:after => 2024}],:name => "Additional public holiday for Christmas Day", :regions => [:au_sa]},
