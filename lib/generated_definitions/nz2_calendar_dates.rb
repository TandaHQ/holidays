...
module Holidays
  ...
  module NZ2_CALENDAR_DATES # :nodoc:
    ...
    def self.holidays_by_month
      ...
      6 => [{:wday => 1, :week => 1,  :year_ranges => [{:before => 2022}],:name => "Queen's Birthday", :regions => [:nz2_calendar_dates]},
            {:wday => 1, :week => 1,  :year_ranges => [{:after => 2023}],:name => "King's Birthday", :regions => [:nz2_calendar_dates]},
