...
class DefinitionLoadingTests < Test::Unit::TestCase
  ...
  # :us used to be handed :ca as its parent, because ca.rb declares it, so asking
  # for :us loaded ca.rb and never us.rb. These pin that :us now owns its own
  # definitions rather than borrowing another country's.
